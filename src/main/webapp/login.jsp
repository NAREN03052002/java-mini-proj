...
<body class="min-h-screen flex items-center justify-center">
    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-sm p-8 m-4">
        <h3 class="text-3xl font-bold text-gray-800 mb-1 text-center">Welcome Back</h3>
        <p class="text-sm text-gray-500 mb-6 text-center">Sign in to leave feedback.</p>
        ...
        <p class="mt-6 text-center text-sm text-gray-600">
            Don't have an account? <a href="signup.jsp" class="font-semibold text-indigo-600 hover:text-indigo-500">Sign up here</a>
        </p>
    </div>
</body>
</html>
