 ...
 * (Reverted to fixed fields)
 */
public class Feedback {
    private int id; // Simulates a primary key
    private int courseId;
    
    // Fixed rating parameters (1-5 scale)
    private int qualityRating; // Teaching quality
    private int assignmentRating; // Assignment load/relevance
    private int gradingRating; // Grading fairness
